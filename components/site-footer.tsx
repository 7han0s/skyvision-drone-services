      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/services/real-estate-photography" className="text-slate-600 hover:text-orange-500">
                  Real Estate Photography
                </Link>
              </li>
              <li>
                <Link href="/services/event-coverage" className="text-slate-600 hover:text-orange-500">
                  Event Coverage
                </Link>
              </li>
              <li>
                <Link href="/services/promotional-content" className="text-slate-600 hover:text-orange-500">
                  Promotional Content
                </Link>
              </li>
              <li>
                <Link href="/services/tourism-hospitality" className="text-slate-600 hover:text-orange-500">
                  Tourism & Hospitality
                </Link>
              </li>
              <li>
                <Link href="/partner-with-us" className="text-slate-600 hover:text-orange-500">
                  Partner with Us
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t pt-8 md:flex md:items-center md:justify-between">
          <div className="flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-6">
            ...
            <div className="flex space-x-4 text-sm">
              ...
              <Link href="/terms-of-service" className="text-slate-600 hover:text-orange-500">
                Terms of Service
              </Link>
              <Link href="/sitemap" className="text-slate-600 hover:text-orange-500">
                Sitemap
              </Link>
            </div>
          </div>
